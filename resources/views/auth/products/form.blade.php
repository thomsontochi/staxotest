                    ...
                    <form method="POST" action="{{ isset($product) ? route('products.update', $product->id) : route('products.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <x-input id="name" class="block mt-1 w-full" type="text" name="name" value="{{ old('name', isset($product) ? $product->name : '') }}"  />
                            </div>

                            <div>
                                <x-label for="price" :value="__('Price')" />
                                <x-input id="price" class="block mt-1 w-full" type="text" name="price" value="{{ old('price', isset($product) ? $product->price : '') }}"  />
                            </div>
